...
`;class _t extends at{constructor(){super(...arguments),this._summary=null,this._error=null}setConfig(t){this._config={show_gas:!0,show_ev:!0,show_costs:!0,...t}}getCardSize(){return 3}firstUpdated(){this._loadData()}async _loadData(){if(this.hass)try{this._summary=await async function(t){return t.callWS({type:"eon_next/dashboard_summary"})}(this.hass),this._error=null}catch(t){this._error=t instanceof Error?t.message:String(t)}}render(){if(this._error)return W`<ha-card>
        <div class="error">Error: ${this._error}</div>
      </ha-card>`;if(!this._summary)return W`<ha-card>
        <div class="card-content secondary-text">Loading…</div>
      </ha-card>`;const t=this._summary.meters.filter(t=>"electricity"===t.type),e=this._summary.meters.filter(t=>"gas"===t.type),s=!1!==this._config.show_gas,i=!1!==this._config.show_ev,r=!1!==this._config.show_costs;return W`
      <ha-card>
        <div class="title">
        ...
        ${t.map(t=>this._renderMeter(t,"Electricity","mdi:flash",r))}
        ${s?e.map(t=>this._renderMeter(t,"Gas","mdi:fire",r)):q}

        ${i&&this._summary.ev_chargers.length>0?W`<div class="meter-section">
              <div class="meter-label">
                <ha-icon icon="mdi:ev-station" style="--mdc-icon-size: 16px;"></ha-icon>
                EV Charging
              </div>
              ${this._summary.ev_chargers.map(t=>W`
                  <div class="stat-row">
    ...
    `],t([dt({attribute:!1})],_t.prototype,"hass",void 0),t([pt()],_t.prototype,"_config",void 0),t([pt()],_t.prototype,"_summary",void 0),t([pt()],_t.prototype,"_error",void 0),customElements.define("eon-next-summary-card",_t),window.customCards=window.customCards||[],window.customCards.push({type:"eon-next-summary-card",name:"EON Next Summary",description:"Compact overview of your EON Next energy data including consumption, costs, and EV charging status.",preview:!0});
