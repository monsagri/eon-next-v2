...
`;class ft extends at{constructor(){super(...arguments),this._data=new pt(this,t=>async function(t){return t.callWS({type:"eon_next/dashboard_summary"})}(t))}setConfig(t){this._config={show_gas:!0,show_ev:!0,show_costs:!0,...t}}getCardSize(){return 3}render(){if(this._data.error)return q`<ha-card>
        <div class="error">Error: ${this._data.error}</div>
      </ha-card>`;if(!this._data.data)return q`<ha-card>
        <div class="card-content secondary-text">Loading…</div>
      </ha-card>`;const{meters:t,ev_chargers:e}=this._data.data,s=t.filter(t=>"electricity"===t.type),i=t.filter(t=>"gas"===t.type),r=!1!==this._config.show_gas,o=!1!==this._config.show_ev,n=!1!==this._config.show_costs;return q`
      <ha-card>
        <div class="title">
        ...
        ${o&&e.length>0?q`<div class="meter-section">
              <div class="meter-label">
